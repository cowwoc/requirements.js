...
class Strings
{
	 ...
	 * <p>
	 * The returned index is the largest value <code>k</code> for which <code>source.startsWith(target, k)</code>
	 * consecutively. If no such value of <code>k</code> exists, then <code>-1</code> is returned.
	 *
	 * @param {string} source the string to search within
	 * @param {string} target the string to search for
	 * @return {number} the index of the last consecutive occurrence of <code>target</code> in <code>source</code>, or
