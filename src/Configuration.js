 ...
 *
 * @property {RequirementVerifier} internalVerifier the verifier that can be used to check a verifier's own parameters
 * @property {Error} exceptionOverride the type of exception to throw, {@code null} to throw the default exception
 *                  type
 * @property {Array<Object>} context a list of key-value pairs to append to the exception message
...
Configuration.prototype.addContext = function(key, value)
{
	...
	const newContext = [...this.context, {key: this.value}];
