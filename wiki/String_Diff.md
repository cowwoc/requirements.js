When a [String comparison](https://cowwoc.github.io/requirements.js/2.0.7/docs/api/ObjectVerifier.html#isEqualTo)
...
Users can override this behavior by invoking [GlobalRequirements.withTerminalEncoding()](https://cowwoc.github.io/requirements.js/2.0.7/docs/api/module-GlobalRequirements-GlobalRequirements.html#.withTerminalEncoding).