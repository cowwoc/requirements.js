...
# <img src="https://raw.githubusercontent.com/cowwoc/requirements.js/release-3.0.0/wiki/checklist.svg?sanitize=true" width=64 height=64 alt="checklist"> Requirements.js
Fluent Design by Contract for Javascript

[![API](https://img.shields.io/badge/api_docs-5B45D5.svg)](https://cowwoc.github.io/requirements.js/3.0.0/docs/api/)
...
```
npm install --save @cowwoc/requirements@3.0.0
```

or [yarn](https://yarnpkg.com/en/):

```
yarn add @cowwoc/requirements@3.0.0
```
...
* [requireThat(value, name)](https://cowwoc.github.io/requirements.js/3.0.0/docs/api/module-DefaultRequirements.html#~requireThat)
* [assertThat(value, name)](https://cowwoc.github.io/requirements.js/3.0.0/docs/api/module-DefaultRequirements.html#~assertThat)
* [validateThat(value, name)](https://cowwoc.github.io/requirements.js/3.0.0/docs/api/module-DefaultRequirements.html#~validateThat)
* [Requirements](https://cowwoc.github.io/requirements.js/3.0.0/docs/api/module-Requirements-Requirements.html)
* [GlobalRequirements](https://cowwoc.github.io/requirements.js/3.0.0/docs/api/module-GlobalRequirements-GlobalRequirements.html)
